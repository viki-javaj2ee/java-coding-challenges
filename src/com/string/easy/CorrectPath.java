...
public class CorrectPathTest {
	...
	public static void main(String[] args) {
		System.out.println("\t[ Inside CorrectPath ]");
		Scanner sc = new Scanner(System.in);

		System.out.print("\n\nEnter string - ");
		String inputStr = sc.nextLine();

		System.out.println("\nSoution 1 answer: " + correctPath1(inputStr));
		System.out.println("\nSoution 2 answer: " + correctPath2(inputStr));
		System.out.println("\nSoution 2 answer: " + correctPath3(inputStr));
		sc.close();
	}
	...
	public static String correctPath2(String str) {
		 return null;
	}

	public static String correctPath3(String str) {
		 return null;
	}
